...
class GetAllManagedProjectTest(TestCase):
    ...
    def test_get_all_managed_projects_authenticated(self):
        ...
        response = self.client.get(self.url, headers=headers)  # Adjust this URL to your actual endpoint
        ...
        self.assertNotIn('Other Project', project_names)  # Should not see the project of other user

    def test_get_all_managed_projects_unauthenticated(self):
        """Test that unauthenticated users cannot access the managed projects."""
        response = self.client.get(self.url)  # Adjust this URL to your actual endpoint
